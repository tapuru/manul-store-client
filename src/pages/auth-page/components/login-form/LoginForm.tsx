import { Button, AppText, TextInput, Alert, Loader } from '../../../../components/ui';
import { AppForm } from '../../../../components';
import { Link, useNavigate } from 'react-router-dom';
import { useEffect, useState } from 'react';
import { ILoginInput, useLoginMutation } from '../../../../store/slices/auth/authApiSlice';
...
export const LoginForm = () => {
  ...
  const [inputData, setInputData] = useState<ILoginInput>({ email: "", password: "" });
